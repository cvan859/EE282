...
my_species <- c('contigs', 'contigs', 'contigs', 'contigs', 'unitigs', 'unitigs', 'unitigs', 'unitigs', 'scaffold', 'scaffold', 'scaffold', 'scaffold')
...
my_percentage <- c(98.5, 0.2, 0.5, 0.8, 11.6, 0.0, 4.9, 83.5, 98.5, 0.2, 0.5, 0.8)
my_values <- c(3235, 8, 16, 26, 380, 0, 160, 2745, 3235, 8, 16, 26)
